 ...
 * the computations of the MIXMAX article (to be published).
 *
 * To compile this program you should use something similar to :
 *      g++ -I./include -I./latticetester/include -c \
 *      ./examples/MixMaxLatticeAnalysis/SavvidyMatricesAnalysis.cc \
 *      -L./lib -llatmrg -llatticetester -L/usr/local/lib -lntl -lgmp -o \
 *      ./examples/MixMaxLatticeAnalysis/SavvidyMatricesAnalysis
 ...
 *      ./SavvidyMatricesAnalysis < xx.txt
 * in this directory (Assuming you compiled with the command above, xx are the
 * numbers of one of the files).
 *
