...
static void testMWCProposal(int64_t k, int64_t e, IntVec aa) {
   ...
   if (IntFactor<Int>::isPrime((m-Int(1))/Int(2)) <= 1)
      std::cout << " (m=1)/2 = " << (m-1)/2 << " is prime.\n";
   else
      std::cout << " (m=1)/2 = " << (m-1)/2 << " is NOT prime.\n";
   Int suma2 = aa[0] * aa[0];
...
int main() {
   ...
   aa[7] = conv<ZZ>(1066);
   aa[8] = conv<ZZ>(12013);
   testMWCProposal<Int, Real>(8, 16, aa);
   ...
   testMWCProposal<Int, Real>(2, 32, aa);
   ...
   aa[46] = -2;
   aa[48] = 2;
   testMWCProposal<Int, Real>(48, 24, aa);
   ...
   aa[38] = -2;
   aa[41] = 2;
   testMWCProposal<Int, Real>(41, 24, aa);
   ...
   aa[20] = -2;
   aa[22] = 2;
   testMWCProposal<Int, Real>(22, 25, aa);
   ...
   aa[20] = -4;
   aa[33] = 4;
   testMWCProposal<Int, Real>(33, 32, aa);
...
//   return 0;
   ...
   testMWCProposal<Int, Real>(3, 64, aa);
