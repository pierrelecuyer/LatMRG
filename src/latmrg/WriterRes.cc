...
namespace LatMRG
{
  WriterRes::WriterRes (const char * fileName, unsigned int margins):
    Writer (fileName)
  {
    m_margins = margins;
  }
  ...
  void WriterRes::endTabbedSection ()
  {
    m_prefix = "";
  }
  ...
  void WriterRes::writeMathString (const string s)
  {
    *m_stream << m_prefix << s;
  }
  ...
  void WriterRes::writeStandOutMathString (const string s)
  {
