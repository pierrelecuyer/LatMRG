...
namespace LatMRG {
  namespace Reductions {
    template void reduceFull(LatticeTester::IntLattice<std::int64_t, std::int64_t, double, double>& lat);
    template void reduceFull(LatticeTester::IntLattice<NTL::ZZ, NTL::ZZ, double, double>& lat);
    template void reduceFull(LatticeTester::IntLattice<NTL::ZZ, NTL::ZZ, NTL::RR, NTL::RR>& lat);
