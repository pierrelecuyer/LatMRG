  ...
  template <typename Int>
    class IntFactorization {
      public:
        ...
        /**
         * Returns the list of the inverse factors.
         */
         ...
         */
        void setStatus (PrimeType status) { m_status = status; }
      ...
      private:
        ...
        class CompareFactors {
          public:
            bool operator() (const IntFactor<Int> & f1,
                const IntFactor<Int> & f2) {
...
// IMPLEMENTATION
  ...
  template<typename Int>
    bool IntFactorization<Int>::checkProduct () const  {
      Int temp;
      temp = 1;
      typename std::list<IntFactor<Int>>::const_iterator it =
        m_factorList.begin ();
      while (it != m_factorList.end ()) {
