...
protected:
   ...
   /**
    * The following protected functions take the basis matrix as a parameter for more flexibility.
...
// This function returns the value of `projCase1`, which is `true` iff the first m_order coordinates
