...
#ifndef LATMRG__PROJECTION_DEPENDENT_WEIGHTS_H
#define LATMRG__PROJECTION_DEPENDENT_WEIGHTS_H
 ...
 *   #operator>>(std::istream&, LatMRG::Coordinates&)
 ...
 *
 * \sa  #operator>>(std::istream&, LatMRG::Coordinates&)
 */
